...
open class MockOAuth2SessionWithValidAccessTokenStored: OAuth2Session {
    ...
    open func saveAccessToken(_ accessToken: String?, refreshToken: String?, accessTokenExpiration: String?, refreshTokenExpiration: String?, idToken: String?) {}
    public init() {}
}
...
open class MockOAuth2SessionWithRefreshToken: MockOAuth2SessionWithValidAccessTokenStored {
    ...
    open override func saveAccessToken(_ accessToken: String?, refreshToken: String?, accessTokenExpiration: String?, refreshTokenExpiration: String?, idToken: String?) {
